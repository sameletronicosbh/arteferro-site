    ...
    <div className="relative min-h-screen text-[var(--text-main)] selection:bg-brand-orange selection:text-white">
      ...
      <main>
        ...
        <section className="py-24 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-[#c94e2f] via-brand-orange to-[#9f321f]" />
          ...
          <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center text-white">
            <h2 className="text-4xl md:text-7xl font-black uppercase mb-8 leading-[0.9] max-w-5xl">
              Transforme seu <br />ambiente com <br /><span className="text-black/80">design industrial.</span>
            </h2>
            <p className="text-lg md:text-xl font-medium mb-12 max-w-3xl text-white/90 leading-relaxed">
              Criamos móveis sob medida em metal e madeira para ambientes sofisticados, modernos e cheios de personalidade.
            </p>
            <a 
              href="https://wa.me/5531993116196" 
              className="bg-zinc-950 text-white px-12 py-5 rounded-sm font-display font-black text-xl uppercase tracking-widest hover:scale-105 hover:bg-white hover:text-zinc-950 transition-all flex items-center gap-3 shadow-2xl"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              ...
              <div className="bg-[var(--bg-card)] p-10 rounded-sm border border-[var(--border-color)] shadow-2xl relative">
                <div className="absolute top-0 right-0 w-24 h-24 bg-brand-orange/5 flex items-center justify-center">
                  <Sofa className="text-brand-orange/40 w-12 h-12 opacity-20" />
                </div>
                ...
                <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-[10px] uppercase tracking-widest font-bold text-[var(--text-main)]/60">Ambiente / Móvel de Interesse</label>
                    <div className="relative">
                      <select className="w-full bg-[var(--bg-alt)] border border-[var(--border-color)] p-4 rounded-sm focus:border-brand-orange outline-none transition-colors appearance-none text-[var(--text-main)]">
                        ...
                        <option>Painel & Rack Industrial</option>
                        <option>Estante Contemporânea</option>
                        <option>Home Office Industrial</option>
                        <option>Aparador & Decoração</option>
                        <option>Móveis Sob Medida</option>
                        <option>Projeto Comercial</option>
                        <option>Consultoria de Ambiente</option>
                      </select>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea 
                      rows={4}
                      placeholder="Conte sobre o ambiente, medidas aproximadas ou o móvel que você deseja..."
